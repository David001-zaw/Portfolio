        ...
        <div class="project-form">
            <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input type="text" class="input-item title" placeholder="Project Title" name="title">
                    <span class="focus-border"></span>
                </div>
                <div class="form-group">
                    <input type="text" class="input-item link" placeholder="Project Demo Link" name="project_link">
                    <span class="focus-border"></span>
                </div>
                <div class="form-group">
                    <input type="text" class="input-item coder" placeholder="Project Coder" name="coder">
                    <span class="focus-border"></span>
                </div>
                <div class="form-group">
                    <textarea spellcheck="false" placeholder="Project Overview..." class="input-item overview" required name="overview"></textarea>
                    <span class="focus-border"></span>
                </div>
                <div class="form-group">
