        ...
        <div class="blog-form">
            <form action="{{ route('blogs.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="form-group">
                    <input type="text" class="input-item title" placeholder="Blog Title" name="title">
                    <span class="focus-border"></span>
                </div>
                <div class="form-group">
                    <input type="text" class="input-item excerpt" placeholder="Blog excerpt" name="excerpt">
                    <span class="focus-border"></span>
                </div>
                <div class="form-group">
