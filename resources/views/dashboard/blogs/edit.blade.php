...
@section('content')
    <div class="container">
        ...
        @endif
        <div class="blog-form">
            <form action="{{ route('blogs.update', $blog) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                @csrf
                @method('PUT')

                <div class="form-group">
                    <input type="text" class="input-item title" placeholder="Blog Title" name="title" value="{{ $blog->title }}">
                    <span class="focus-border"></span>
                </div>
                <div class="form-group">
                    <input type="text" class="input-item excerpt" placeholder="Blog excerpt" name="excerpt" value="{{ $blog->excerpt }}">
                    <span class="focus-border"></span>
                </div>
                <div class="form-group">
                    <textarea name="content" class="content" id="content">{{ $blog->content }}</textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="old-img">
                        ...
                        <img src="{{ asset('frontend/images/blogs/'.$blog->image_path) }}" alt="Image Preview" width="300px" />
                    </div>
                </div>
                <button type="submit" class="main-btn">Update Blog <i class="fa fa-plus"></i></button>
            </form>
        </div>
    </div>
@endsection
