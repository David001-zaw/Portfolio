...
.heart{
    position: absolute;
    background: url('{{ asset('frontend/images/heart_btn/heart_btn.png') }}') no-repeat;
    ...
    <section class="blogDetail" id="blogDetail">
        ...
        <div class="blog">
            <div class="go-to-back">
                <a href="{{ route('blogs') }}" class="line-btn">&larr; Go to Blog List</a>
            </div>
            <div class="blog-heading">
                ...
                <div class="blog-info">
                    ...
                    <div class="category">
                        <a href="#" class="line-btn"><i class="fa fa-folder"></i> {{ $blog->category->name }}</a>
                    </div>
                    <div class="author">
                        <a href="#" class="line-btn"><i class="fas fa-user"></i> {{ $blog->author->name }}</a>
                    </div>
                </div>
            </div>
            <div class="blog-img">
